const quizData = [
    ...
    {
        question: "Quem declarou 'lavo minhas mãos' ao sentenciar Jesus à morte?",
        options: ["Pilatos", "Judas", "Davi", "Pedro"],
        answer: 0
    },
    {
        question: "Quantos anos Jesus tinha quando foi crucificado?",
        options: ["30", "63", "62", "33"],
        answer: 3
    },
    {
        question: "Qual livro da Bíblia é conhecido por conter poesias e canções?",
        options: ["Provérbios", "Salmos", "Eclesiastes", "Apocalipse"],
        answer: 1
    },
    {
        question: "Qual foi o primeiro milagre realizado por Jesus?",
        options: ["Curar um cego", "Ressuscitar um morto", "Transformar água em vinho", "Curar um surdo"],
        answer: 2
    },
    {
        question: "Qual dos apóstolos é tradicionalmente reconhecido como o autor do Livro de Apocalipse?",
        options: ["João", "Pedro", "Tiago", "Paulo"],
        answer: 0
    },
    {
        question: "Quem foi o rei que sucedeu Davi e é famoso por ter construído o templo em Jerusalém?",
        options: ["Saul", "Salomão", "Roboão", "Josias"],
        answer: 1
    },
    {
        question: "Qual mulher ajudou os espiões israelitas em Jericó?",
        options: ["Ana", "Raabe", "Ester", "Ruth"],
        answer: 1
    },
    {
        question: "Quais são os quatro evangelistas?",
        options: ["Mateus, Marcos, João e Lucas", "Mateus, Jonas, Leandro e Jesus", "Márcio, Madalena, Lucas e Cristóvão", "Modric, Messi, Neymar e Cristiano"],
        answer: 0
    },
    {
        question: "Qual apóstolo é conhecido como 'Dúvida'?",
        options: ["Tomé", "Mateus", "Simão", "Judas"],
        answer: 0
    },
    {
        question: "Antes de se tornar apóstolo, qual era a profissão de Paulo?",
        options: ["Pescador", "Carpinteiro", "Professor", "Fabricante de tendas"],
        answer: 3
    }
